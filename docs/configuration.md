...
The list of Backstage user entity refs that are granted the `service-tokens.admin` permission. Users not in this list receive `403 Forbidden` on all service token API endpoints.
