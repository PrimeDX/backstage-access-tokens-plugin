...
/**
 * Decode a `#personal-access-tokens-mint=<base64url-payload>` fragment string and
 ...
 * @returns {{ type: 'personal-access-tokens-mint-result', flowId: string, token: string,
...
export function parseMintResultFragment(hash) {
  ...
  const prefix = '#personal-access-tokens-mint=';
  ...
  if (payload.type !== 'personal-access-tokens-mint-result') return null;
