...
test('handleCreateToken returns 201 with token and rawToken on success', async () => {
  ...
  assert.deepEqual(response.body, {
    ...
    rawToken: 'bsat_dGhpcyBpcyBub3QgYSByZWFsIHRva2Vu',
  });
});
