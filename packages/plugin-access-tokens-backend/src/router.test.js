...
test('router dispatches POST /api/access-tokens/service', async () => {
  ...
  const response = await api.handle({
    method: 'POST',
    path: '/api/access-tokens/service',
    body: {
      name: 'cicd-pipeline',
...
test('router dispatches GET /api/access-tokens/service with query', async () => {
  const api = createHttpApi({
...
test('router dispatches GET /api/access-tokens/service/:id', async () => {
  const api = createHttpApi({
  ...
  const response = await api.handle({
    method: 'GET',
    path: '/api/access-tokens/service/token-1',
  });
...
test('router dispatches DELETE /api/access-tokens/service/:id', async () => {
  const now = new Date('2026-04-04T12:00:00.000Z');
  const api = createHttpApi({
    db: createInMemoryServiceTokenDatabase({
      now: () => now,
...
test('router dispatches GET /api/access-tokens/service/:id/audit', async () => {
  const api = createHttpApi({
    db: createInMemoryServiceTokenDatabase({
      auditEvents: [
        {
  ...
  const response = await api.handle({
    method: 'GET',
    path: '/api/access-tokens/service/token-1/audit',
  });
...
test('router dispatches GET /api/access-tokens/service/scopes', async () => {
  const api = createHttpApi({
    db: createInMemoryServiceTokenDatabase({ tokens: [] }),
  });
  ...
  const response = await api.handle({
    method: 'GET',
    path: '/api/access-tokens/service/scopes',
  });
