...
export function createExpressRouter(options) {
  ...
  // --- Read routes: require serviceAccessTokensReadPermission ---
  ...
  // --- Write route: requires serviceAccessTokensWritePermission ---
  ...
  // --- Revoke route: requires serviceAccessTokensRevokePermission ---
