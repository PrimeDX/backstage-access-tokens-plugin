...
test('readUserTokensConfig fills sane defaults when only the key is provided', () => {
  const config = makeConfig({
    accessTokens: { personal: { encryptionKey: validKeyBase64 } },
  });
